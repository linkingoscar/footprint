...
var ExportModule = {
    ...
    exportGPX: function() {
        fetch('/api/export/gpx').then(function(r) { return r.blob(); }).then(function(blob) {
    ...
    exportGeoJSON: function() {
        fetch('/api/export/geojson').then(function(r) { return r.blob(); }).then(function(blob) {
    ...
    exportCSV: function() {
        fetch('/api/export/csv').then(function(r) { return r.blob(); }).then(function(blob) {
...
var ExpenseModule = {
    ...
    remove: function(id) {
        var self = this;
        fetch('/api/expenses/' + id, { method: 'DELETE' }).then(function() {
