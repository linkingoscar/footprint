...
```powershell
# 1. 打开设置页面配置API Key
D:\植物大战僵尸\opencode\photo-map\frontend\settings.html

# 2. 打开主页开始使用
D:\植物大战僵尸\opencode\photo-map\frontend\index.html
```
...
```powershell
# 1. 安装依赖
cd D:\植物大战僵尸\opencode\photo-map
...
- [使用指南](frontend/guide.html) - 用户使用指南
- [设置页面](frontend/settings.html) - 配置API和存储
